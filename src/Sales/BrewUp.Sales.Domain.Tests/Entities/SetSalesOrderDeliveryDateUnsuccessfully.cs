...
public sealed class SetSalesOrderDeliveryDateUnsuccessfully : CommandSpecification<SetSalesOrderDeliveryDate>
{
    ...
    {
        yield return new SalesOrderDomainException(_salesOrderId, _correlationId,
